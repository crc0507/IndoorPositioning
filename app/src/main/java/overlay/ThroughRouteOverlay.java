 ...
 * 导航路线图层类。
 */
public class ThroughRouteOverlay extends RouteOverlay{
     ...
     */
    public ThroughRouteOverlay(Context context, AMap amap, WalkPath path,
	...
	public void addToMap() {
        ...
        try {
            ...
            for (WalkStep step : walkPaths) {
                List<LatLonPoint> latlonPoints = step.getPolyline();
                List<TMC> tmclist = step.getTMCs();
                tmcs.addAll(tmclist);

                addThroughStationMarkers(step, convertToLatLng(latlonPoints.get(0)));
     ...
     * @param latLng
     */
    private void addThroughStationMarkers(WalkStep walkStep, LatLng latLng) {
